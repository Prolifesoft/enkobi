...
?>
        <div class="importer-head">
            ...
            <img class="logo" alt="image" src="<?php echo get_template_directory_uri() . '/assets/img/demo-xshop.png'; ?>" />
            <h6>We believe in creating...</h6>
            <h4>simple. beautiful. useful</h4>
            <h2>Xshop Multipurpose Woocommerce Theme</h2>
            <img class="bann full-img" alt="image" src="<?php echo get_template_directory_uri() . '/assets/img/import-demo-ban.png'; ?>" />
                    ...
                    <div class="row">
                        <div class="col-30">
                            <label>
                                ...
                                <img data-layout="solitaire" alt="image" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/solitaire-demo.jpg" />
                        ...
                        <div class="col-30">
                            <label>
                                ...
                                <img data-layout="jewelia" alt="image" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/jewelia-demo.jpg" />
                                <button name="submit" class="panel-save button-primary" type="submit">
                                    <i class="fa fa-check" aria-hidden="true"></i> Click to import
                                </button>
                            </label>
                        ...
                        <div class="col-30">
                            <label>
                                ...
                                <img data-layout="quark1" alt="image" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/quark-demo.jpg" />
                                <button name="submit" class="panel-save button-primary" type="submit">
                                    <i class="fa fa-check" aria-hidden="true"></i> Click to import
                                </button>
                            </label>
                        ...
                        <div class="col-30">
                            <label>
                                ...
                                <img data-layout="quark2" alt="image" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/quark-2-demo.jpg" />
                                <button name="submit" class="panel-save button-primary" type="submit">
                                    <i class="fa fa-check" aria-hidden="true"></i> Click to import
                                </button>
                            </label>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                jQuery('.solitaire-importer .col-30').click(function(e) {
                    jQuery('.solitaire-importer .col-30').find('.panel-save').css({
                        'visibility': 'hidden',
                        'bottom': '15px',
                        'left': '15px'
                    });
                    jQuery(this).find('.panel-save').css({
                        'visibility': 'visible',
                        'bottom': '0',
                        'left': '0'
                    });
