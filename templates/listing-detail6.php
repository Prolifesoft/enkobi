...
wp_enqueue_style('single-classic', THEME_DIR . '/assets/css/classic/single-classic.css');
if ( have_posts() ) {
    while ( have_posts() ) {
        the_post();
        ...
        <section class="aliceblue listing-second-view">
            ...
            <?php
            //gallery
            include ( locate_template( 'templates/single-list/listing-details-style6/content/gallery.php' ) );
            //title bar
            include ( locate_template( 'templates/single-list/listing-details-style6/content/title-bar.php' ) );
            ?>
            <div class="content-white-area-classic">
                <div class="container single-inner-classic-container single_listing" >
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <?php
                            $pagelayoutOption = $listingpro_options['lp-detail-page-layout6-content']['general'];
                            if ($pagelayoutOption):
                                foreach ($pagelayoutOption as $key=>$value) {
                                    switch($key) {

                                        case 'lp_video_section': get_template_part( 'templates/single-list/listing-details-style6/content/video' );
                                            break;

                                        case 'lp_content_section': get_template_part( 'templates/single-list/listing-details-style6/content/content' );
                                            break;
                                        case 'lp_features_section': get_template_part( 'templates/single-list/listing-details-style6/content/features' );
                                            break;

                                        case 'lp_additional_section': get_template_part( 'templates/single-list/listing-details-style6/content/additional' );
                                            break;

                                        case 'lp_faqs_section': get_template_part( 'templates/single-list/listing-details-style6/content/faqs' );
                                            break;

                                        case 'lp_reviews_section': get_template_part( 'templates/single-list/listing-details-style6/content/reviews' );
                                            break;

                                        case 'lp_announcements_section' :
                                            get_template_part( 'templates/single-list/listing-details-style6/content/list-announcements' );
                                            break;
                                        case 'lp_menu_section': get_template_part( 'templates/single-list/listing-details-style6/content/list-menu' );
                                            break;

                                        case 'lp_reviewform_section': get_template_part( 'templates/single-list/listing-details-style6/content/reviewform' );
                                            break;
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <?php
                            $pagesidebrOption = $listingpro_options['lp-detail-page-layout6-rsidebar']['sidebar'];
                            if ($pagesidebrOption):
                                    ...
                                    switch($key) {
                                        ...
                                        case 'lp_booking_section':
                                            if(class_exists('Listingpro_bookings')){
                                                echo '<div class="classic-booking-appointment">';
                                                    include( WP_CONTENT_DIR . '/plugins/listingpro-bookings/templates/bookings.php' );
                                                echo '</div>';
                                            }
                                            break;
                                        case 'lp_timing_section': get_template_part( 'templates/single-list/listing-details-style6/sidebar/timings' );
                                            break;

                                        case 'lp_mapsocial_section': get_template_part( 'templates/single-list/listing-details-style6/sidebar/map-contacts' );
                                            break;

                                        case 'lp_leadform_section': get_template_part( 'templates/single-list/listing-details-style6/sidebar/leadform' );
                                            break;

                                        case 'lp_quicks_section': get_template_part( 'templates/single-list/listing-details-style6/sidebar/quicks' );
                                            break;

                                        case 'lp_additional_section': get_template_part( 'templates/single-list/listing-details-style6/sidebar/additional' );
                                            break;

                                        case 'lp_sidebarelemnts_section': get_template_part( 'templates/single-list/listing-details-style6/sidebar/def-sidebar' );
                                            break;
                                        case 'lp_event_section':
                                            $post_author_id = get_post_field( 'post_author', get_the_ID() );
                                            $event_displayin =   get_user_meta( $post_author_id, 'event_display_area', true );
