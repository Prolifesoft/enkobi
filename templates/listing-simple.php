...
?>
	...
	<section>
        ...
        ?>
        <div data-layout-class="<?php echo esc_attr($layout_class); ?>" id="list-grid-view-v2" class="swtch-ll <?php echo esc_attr($header_style_v2); ?> <?php echo esc_attr($v2_map_class); ?> <?php echo esc_attr($listing_layout); ?>"></div>
        <?php endif; ?>
		<div class="container page-container listing-simple <?php echo esc_attr($addClassListing); ?> <?php echo esc_attr($addClassListing2); ?>">
			...
			<div class="content-grids-wraps">
				...
				?>
				<div class="row lp-list-page-grid <?php echo esc_attr($addClasscompact); ?>" id="content-grids" >
                    <?php
                    if( $listing_layout == 'list_view_v2' )
                    {
