<?php
wp_enqueue_style('lp-classic-archive');
$type = 'listing';
$mtQuery = array();
$term_id = '';
$taxName = '';
...
<!--==================================Section Open=================================-->
<section class="page-container clearfix open-clasic-page-container section-fixed listing-with-map pos-relative taxonomy" id="<?php echo esc_attr($taxName); ?>">
	<?php
	$v2_map_class   =   '';
	...
	<div class=" pull-left post-with-map-container-right classic-layout">
		<div class="post-with-map-container pull-left ">
			...
			<div class="margin-bottom-20 margin-top-30">
				<?php get_template_part('templates/search/classic-filter'); ?>
			</div>
