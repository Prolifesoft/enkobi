    ...
    if (isset($_GET['lp_s_loc']) && !empty($_GET['lp_s_loc'])) {
        ...
        if (is_numeric($sloc)) {
            ...
            if ($listingpro_options['lp_listing_search_locations_type'] == 'auto_loc') :
                ...
                $url = $lp_file_content('https://maps.googleapis.com/maps/api/geocode/json?address=' . $sloc . '&key=' . $listingpro_options['google_map_api']);
                $array = json_decode($url, TRUE);
                if (isset($array['results'][0]['address_components'][1]['long_name'])) :
                    if (!empty($array['results'][0]['address_components'][1]['long_name'])) :
                        $city_name = $array['results'][0]['address_components'][1]['long_name'];
                        $term = listingpro_term_exist($city_name, 'location');
                        if (!empty($term)) {
                            $sloc = $term['term_id'];
                            ...
                            $locName = esc_html__('In ', 'listingpro') . $city_name;
                        }
                    else :
                        $termo = get_term_by('id', $sloc, 'location');
                        if (!empty($termo)) {
...
?>
<div class="row listing-classic-filters listing-style-<?php echo esc_attr($listing_style); ?>">
    <div class="col-md-12 search-row search-row-classic margin-top-subtract-35">
        <form autocomplete="off" class="clearfix" method="post" enctype="multipart/form-data" id="searchform">
            <div class="filter-top-section pos-relative classic-top-filters">
                <div class="lp-title">
                    <?php if (is_search()) { ?>
                        <h3 class="test" data-rstring='<?php echo wp_kses_post($termNameAJAX); ?>'><?php echo wp_kses_post($termName); ?> <?php echo wp_kses_post($emptySearchTitle); ?><?php echo wp_kses_post($locName); ?></h3>
                    <?php } else { ?>
                        <h3 class="test2" data-rstring='<?php echo wp_kses_post($termNameAJAX); ?>'><?php echo esc_html__('Results For ', 'listingpro'); ?> <span class="font-bold term-name"><?php echo wp_kses_post($termName); ?></span> </h3>
                    <?php } ?>
                </div>
                <div class="lp-classic-top-filters">
                        ...
                        <div class="search-filters form-group padding-right-0">
                            <ul>
                                <li class="lp-tooltip-outer">
                                    <a class="btn classic-sortingby-select-option default"><?php echo esc_html__('Sort By', 'listingpro'); ?>:<span> <?php echo esc_html__('Most Reviewed', 'listingpro'); ?></span> <i class="fa-sharp fa-solid fa-caret-down"></i></a>
                    ...
                    ?>
                                <div class="listing-view-layout">
                                    <ul>
                                        <li><a class="grid <?php echo esc_attr($GridClass); ?>" href="#"><i class="fa fa-th-large" aria-hidden="true"></i></a></li>
                                        <li><a class="list <?php echo esc_attr($ListClass); ?>" href="#"><i class="fa-solid fa-list"></i></a></li>
                            ...
                            <div class="classic-filters-new-style">
                                ...
                                ?>
                                    <div data-nearmeunit="<?php echo esc_attr($units); ?>" id="lp-find-near-me" class="search-filters form-group padding-right-0">
                                        <ul>
                                            <li class="lp-tooltip-outer">
                                                <a class="btn default near-me-btn"><i class="fa-solid fa-location-arrow"></i> <?php echo esc_html__('Near Me', 'listingpro'); ?></a>
                                                <div class="lp-tooltip-div">
                                                    <div class="lp-tooltip-arrow"></div>
                                                            ...
                                                            <div id="pac-container" class="clearfix">
                                                                <div class="clearfix row">
                                                                    <div class="lp-price-range-btnn col-md-1 text-right padding-0">
                                                                        <?php echo esc_attr($minRange); ?>
                                                                    </div>
                                                                    <div class="col-md-9" id="distance_range_div">
                                                                        <input id="distance_range" name="distance_range" type="text" data-slider-min="<?php echo esc_attr($minRange); ?>" data-slider-max="<?php echo esc_attr($maxRange); ?>" data-slider-step="1" data-slider-value="<?php echo esc_attr($defVal) ?>" />
                                                                    </div>
                                                                    <div class="col-md-2 padding-0 text-left lp-price-range-btnn">
                                                                        <?php echo esc_attr($maxRange); ?>
                                                                    </div>
                                ...
                                ?>
                                    <div class="form-group padding-right-0">
                                        ...
                                        <div class="search-filters">
                                            <ul>
                                                <li class="lp-tooltip-outer">
                                                     <a class=""><?php echo esc_attr($lp_priceSymbol); ?> <?php echo esc_html__('Price', 'listingpro'); ?></a>
                                                    <div class="lp-tooltip-div">
                                                        <div class="lp-tooltip-arrow"></div>
                                                        <div class="lp-tool-tip-content clearfix">
                                                            <div class="currency-signs search-filter-attr">
                                                                <ul class="priceRangeFilter">
                                                                    ...
                                                                    <li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__('Inexpensive', 'listingpro'); ?>" id="one"><a href="#" data-price="inexpensive"><?php echo esc_attr($lp_priceSymbol); ?></a></li>
                                                                    <li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__('Moderate', 'listingpro'); ?>" id="two"><a href="#" data-price="moderate"><?php echo esc_attr($lp_priceSymbol2); ?></a></li>
                                                                    <li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__('Pricey', 'listingpro'); ?>" id="three"><a href="#" data-price="pricey"><?php echo esc_attr($lp_priceSymbol3); ?></a></li>
                                                                    <li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__('Ultra High End', 'listingpro'); ?>" id="four"><a href="#" data-price="ultra_high_end"><?php echo esc_attr($lp_priceSymbol4); ?></a></li>
                                                                </ul>
                                                            </div>
                                    ...
                                    <div class="search-filters form-group">
                                        <ul>
                                            <li class="lp-tooltip-outer listing_openTime">
                                                ...
                                                <a data-time="close"><i class="fa-sharp fa-solid fa-clock"></i> <?php echo esc_html__('Open Now', 'listingpro'); ?></a>
                                                <div class="lp-tooltip-div">
                                                    <div class="lp-tooltip-arrow"></div>
                                                    <div class="lp-tool-tip-content clearfix lp-tooltip-outer-responsive">
                                                        <p class="margin-0">
                                ...
                                if (!empty($radiusOPT) && $radiusOPT == '1') {
                                    if (is_ssl() || LP_if_localhost() == 'true') {
                                ?>
                                                                ...
                                                                <div id="pac-container" class="clearfix">
                                                                    <div>
                                                                        <div id="distance_range_div">
                                                                            <input id="distance_range" name="distance_range" type="text" data-slider-min="<?php echo esc_attr($minRange); ?>" data-slider-max="<?php echo esc_attr($maxRange); ?>" data-slider-step="1" data-slider-value="100" />
                                    ...
                                    <div class="search-filters form-group padding-right-0">
                                        <div class="lp_add_more_filter">
                                            <a class="btn default" ><i class="fa fa-filter" aria-hidden="true"></i>
                                                <?php echo esc_html__('All Filters', 'listingpro'); ?>
                                            </a>
                                        </div>
                                    </div>
                                <?php
            ...
            <input type="hidden" name="lp_search_loc" id="lp_search_loc" value="<?php echo esc_attr($loc_ID); ?>" />

            <?php

            if ($taxTaxDisplay == true) {
        ...
        <div class="lp-s-hidden-ara hide">
            ...
            if (!isset($_GET['lp_s_cat']) || empty($_GET['lp_s_cat'])) {
				$select_value = isset($_GET['select']) ? sanitize_text_field($_GET['select']) : '';
				echo '<input type="hidden" id="lp_current_query" value="' . esc_attr($select_value) . '">';
			}
