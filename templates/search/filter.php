            ...
            <form autocomplete="off" class="clearfix" method="post" enctype="multipart/form-data" id="searchform">
                <div class="filter-top-section pos-relative row">
                    <div class="lp-title col-md-10 col-sm-10">
                        <?php if(is_search()){ ?>
                            <h3 class="test" data-rstring='<?php echo wp_kses_post($termNameAJAX); ?>'><?php echo wp_kses_post($termName); ?> <?php echo wp_kses_post($emptySearchTitle); ?><span class="dename"></span><span class="font-bold lstring"><?php echo esc_html__( ' Listings', 'listingpro' );?></span> <?php echo wp_kses_post($locName); ?></h3>
                        <?php }else{ ?>
                            <h3 class="test2" data-rstring='<?php echo wp_kses_post($termNameAJAX); ?>'><?php echo esc_html__( 'Results For ', 'listingpro' );?> <span class="font-bold term-name"><?php echo wp_kses_post($termName); ?></span> <span class="font-bold lstring"><?php echo esc_html__( ' Listings', 'listingpro' );?></span> </h3>
                        <?php } ?>
                    </div>
                    <?php
