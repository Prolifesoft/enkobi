					...
					<div class="form-group lp-suggested-search <?php echo esc_attr($hideWhereClass); ?> <?php echo esc_attr($hideWhatClass); ?>">
						...
						<div class="pos-relative">
							<div class="what-placeholder pos-relative" data-holder="">
								<input autocomplete="off" type="text" class="lp-suggested-search js-typeahead-input lp-search-input form-control ui-autocomplete-input dropdown_fields" name="select" id="select" placeholder="<?php echo esc_attr($search_placeholder); ?>" data-prev-value='0' data-noresult="<?php echo esc_html__('More results for', 'listingpro'); ?>" value="<?php echo esc_attr($sQuery); ?>">
				...
				?>
						<div class="form-group lp-location-search <?php echo esc_attr($hideWhatClass); ?>">
							...
							<div data-option="<?php echo esc_attr($locOption); ?>" class="<?php echo esc_attr($srchBr); ?>">
								...
								<input autocomplete="off" id="cities" class="form-control" data-country="<?php echo esc_attr($locArea); ?>" placeholder="<?php echo esc_attr($location_default_text); ?>" value="<?php echo esc_attr($sLocation); ?>">
								<input id="lp_search_loc" type="hidden" autocomplete="off" name="lp_s_loc" value="<?php echo esc_attr($sLoc); ?>">
							</div>
						</div>
					<?php
